...
//Signal Conversion
	...
	static TEDROOMSignal C2TCManager_PCPBKGExecCtrl__C4BKGTCExec_PCPBKGExecCtrl(TEDROOMSignal signal);
	static TEDROOMSignal C4BKGTCExec_PCPBKGExecCtrl__C2TCManager_PCPBKGExecCtrl(TEDROOMSignal signal);
