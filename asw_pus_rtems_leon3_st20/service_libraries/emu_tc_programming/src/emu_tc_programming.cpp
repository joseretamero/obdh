...
EmuGSS_TCProgram20_1 prog_FT_0070_step0(UNITIME_AFTER_POWER_ON+10
,"FT_SOLO_EPD_ICU_SERV_20_0070_Step0, Report PID 20 Value ", 20 );

EmuGSS_TCProgram20_3_uint8 prog_FT_0070_step1(UNITIME_AFTER_POWER_ON+11
,"FT_SOLO_ASW_SERV_20_0070_Step1, Set PID 20 Value to 99",20,99);
...
EmuGSS_TCProgram20_3_uint8 prog_FT_0080_step0(UNITIME_AFTER_POWER_ON+10
,"FT_SOLO_ASW_SERV_20_0080_Step0, Set PID 10 Value to 55",10,55);

EmuGSS_TCProgram20_1 prog_FT_0080_step1(UNITIME_AFTER_POWER_ON+11
,"FT_SOLO_EPD_ICU_SERV_20_0080_Step1, Report PID 10 Value ", 10);

EmuGSS_TCProgram20_3_uint8 prog_FT_0080_step2(UNITIME_AFTER_POWER_ON+12
,"FT_SOLO_ASW_SERV_20_0070_Step1, Set PID 3 Value to 33",3,33);
